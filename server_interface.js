...
// sequences.
    ...
    //josh's revised version because the original isn't working right and I don't understand it well enough to fix it in situ
    function quote(string)
    {
        var ret = '';
...
params - key/values pairs representing the parameters and arguments to pass to the method
...
function method_call_raw(method, params, callback)
{
	...
	for (pname in p)
	{
		p[pname] = serializeVal(p[pname]);
	}
    p.method = method;
    
    function error(XMLHttpRequest, textStatus, errorThrown)
    {
       callback(false, 'Could not connect to server: ' + textStatus);
    }
...
//CODE FOR MAKING MESSAGES DISPLAY NICELY
